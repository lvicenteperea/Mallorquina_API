...
class Settings(BaseSettings):
   ...
   DEV_PROD: str = "PROD" # Cambia a "PROD" para producción
  ...
  # WEB_RUTA_LOCAL: str = "http://localhost:3000/" # "C:/GitHub/Mallorquina_API/"
   ...
   WEB_RUTA_IMAGEN: str = "app/ficheros/imagen/"
   CORS_ALLOWED_ORIGINS: list[str] = ["http://localhost:3000",
                                      "https://intranet.pastelerialamallorquina.es",
                                     ]

   RUTA_LOCAL: str = "/app/" #"C:/GitHub/Mallorquina_API/" # /opt/MALLORQUINBA_API/
